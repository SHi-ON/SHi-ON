...
- 🖥️ [remote-control](https://github.com/Aureuma/remote-control) - Browser-accessible terminal remote control with tmux or TTY attach and optional tunneling.
...
- 🏎️ [ManeuverGPT](https://github.com/SHi-ON/ManeuverGPT) - IROS 2025 project on agentic control for safe autonomous stunt maneuvers.
- 🧰 [mongo-taskqueue](https://github.com/SHi-ON/mongo-taskqueue) - MongoDB-backed task queue for scheduling, retries, deduplication, and worker loops.
...
- 😊 [EmoRecom](https://github.com/SHi-ON/EmoRecom) - Emotion-aware recommendation engine using facial expression detection and Google Places.
- ⚡ [Power-Flow](https://github.com/SHi-ON/Power-Flow) - MATLAB implementation of Gauss-Seidel power-flow analysis.
- 🧠 [dl4marco-bert](https://github.com/nyu-dl/dl4marco-bert) - BERT-based passage ranking baseline used for retrieval experiments.
- ➗ [Simplex](https://github.com/SHi-ON/Simplex) - Simplex algorithm implementation for solving linear programs.

## Legacy

- 🎵 [WaveProcessor](https://github.com/SHi-ON/WaveProcessor) - Tool for up-sampling, down-sampling, and editing `.wav` audio files.
- 📊 [DataVis](https://github.com/SHi-ON/DataVis) - Collection of quick data visualization scripts for several small datasets.
- 🌐 [FreeDom](https://github.com/SHi-ON/FreeDom) - Domain name generator and WHOIS checker for finding available names.
- 💉 [VaxCheckNYC](https://github.com/SHi-ON/VaxCheckNYC) - New York vaccine appointment checker with email notifications.
